...
public class JFontChooser extends JComponent
{
    ...
    public JFontChooser(String[] fontSizeStrings)
    {
        ...
        selectPanel.setPreferredSize(new Dimension(450, 500));

        JPanel contentsPanel = new JPanel(new MigLayout());
        contentsPanel.add(selectPanel, "wrap, grow");
        contentsPanel.add(getSamplePanel(), "grow");
    ...
    protected JPanel getSamplePanel()
    {
        if (samplePanel == null)
        {
            ...
            samplePanel.add(getSampleText(), BorderLayout.CENTER);
        }
        return samplePanel;
    }

    protected JLabel getSampleText()
    {
        if (sampleText == null)
        {
            sampleText = new JLabel("5/10 - 2:34");
